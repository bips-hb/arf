...
CONFIGS=(
  ...
  "forge-sep-large|ARF_BENCH_OPS=forge ARF_BENCH_ROWMODE=separate ARF_BENCH_NEVIDENCE=1000 ARF_BENCH_NSYNTH=10"
  "forge-or-small|ARF_BENCH_OPS=forge ARF_BENCH_ROWMODE=or ARF_BENCH_NEVIDENCE=100 ARF_BENCH_NSYNTH=1"
  "forge-or-large|ARF_BENCH_OPS=forge ARF_BENCH_ROWMODE=or ARF_BENCH_NEVIDENCE=1000 ARF_BENCH_NSYNTH=10"
