...
As expected, all values in the maximum likelihood calculation are shrunk toward a uniform prior when we impose Laplace smoothing. Note also that the two data tables do not have exactly the same rows. This is because we omit zero probability events in the former case to conserve memory.
